...
public class UpdateOffense {
    public static void UpdateOffense(){
        ...
        String q = "SELECT * FROM Offensive_Players WHERE Season = " + Season + " AND Team_Name = " + teamName;
        ...
        q = "UPDATE Offensive_Player SET " + updateStats.substring(0, updateStats.length()-2) + " WHERE Season = " + Season + " AND Player_Name = \"" + Player_Name + "\"" + " AND Team_Name = " + teamName;
        ...
        public static String getStatsToUpdate(int Input){
            ...
            switch(Input) {
              ...
              case 5:
                ...
                break;
              case 6:
                System.out.print("Please enter the number of turnovers: ");
                int turnovers = getInt.getInt();
                Update = "Turnovers = " + turnovers + ", ";
                break;
              default:
                return Update;
            }
