...
public class UpdateOffense {
    public static void UpdateOffense(){
        ...
        String q = "UPDATE Offensive_Player SET " + updateStats.substring(0, updateStats.length()-2) + " WHERE Season = " + Season + " AND Player_Name = \"" + Player_Name + "\"" + " AND Team_Name = " + teamName;
